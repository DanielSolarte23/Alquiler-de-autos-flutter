...
class _MenuprincipalState extends State<Menuprincipal> {
  ...
  Future<void> fetchVehiculos() async {
    final response = await http.get(Uri.parse(
        'https://alquiler-autos-backen-12-10.onrender.com/api/autos')); // Cambia la URL
    ...
    if (response.statusCode == 200) {
      ...
      // Si la solicitud falla, puedes manejarlo aquí
  ...
  void initState() {
    super.initState();
    fetchVehiculos(); // Llamamos la API cuando la vista se construya
  }
          ...
          return Card(
            ...
            child: ListTile(
              title: Column(
                ...
                children: [
                  Text(
                    vehiculo['marca'] ?? 'Marca desconocida',
              ...
              leading: Image.network(
                vehiculo['imagen_url'] ??
                    'https://via.placeholder.com/50', // Asumiendo que la URL de la imagen está en el campo 'imagen_url'
                width: 50,
                height: 50,
                fit: BoxFit.cover,
              ),
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Detallesvehiculo()));
              },
            ),
          );
        },
